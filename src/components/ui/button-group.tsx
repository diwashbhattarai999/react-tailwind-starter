...
function ButtonGroup({
    ...
    return (
        // biome-ignore lint/a11y/useSemanticElements: The role attribute is set to "group" to indicate that this is a group of related elements, and the data-slot attribute is used for styling purposes.
        <div
