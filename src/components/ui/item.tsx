...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
    return (
        // biome-ignore lint/a11y/useSemanticElements: The div element is used here to group items together, and the role="list" attribute is added to indicate that this is a list of items. Each child item can have role="listitem" if needed, but the wrapper itself is not a semantic list element like ul or ol, which allows for more flexible layouts while still providing accessibility information.
        <div
            className={cn(
