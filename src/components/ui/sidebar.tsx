...
function SidebarProvider({
    ...
    const setOpen = useCallback(
        (value: boolean | ((value: boolean) => boolean)) => {
            ...
            // biome-ignore lint/suspicious/noDocumentCookie: This is a client-side component and we need to set the cookie to persist the sidebar state across sessions. We are aware of the security implications and have set the appropriate flags on the cookie.
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: We intentionally do not include setOpen in the dependencies because it is a stable function that does not change between renders. Including it would cause unnecessary re-renders and could lead to performance issues.
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: We intentionally do not include open in the dependencies because the state is derived from the open prop and does not need to trigger a re-render when it changes. Including it would cause unnecessary re-renders and could lead to performance issues.
